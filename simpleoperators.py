...
##        print("mult2 ",self.mult2)
    ...
    def clone(self):
        ...
        copies it's self
        """
        return Term(self.name, self.mult1, self.mult2, self.div)
...
##        print(bit1.termlist[0].mult1)
##        print(bit1.termlist[0].div)
##        print(bit1.termlist[0].mult2)
...
##terms1.devideby2()
##print(terms1.termlist[0].mult1)
##print(terms1.termlist[0].div)
##print(terms1.termlist[0].mult2)
##terms1 = shiftleft(terms1,31)
##print(terms1.termlist[0].mult1)
##print(terms1.termlist[0].div)
##print(terms1.termlist[0].mult2)
