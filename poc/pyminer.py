...
class Miner:
	...
	def work(self, datastr, targetstr):
		...
		print "hashMerkleRoot: {0}".format(datastr[36:68])
		print "Time: {0}".format(datastr[68:72])
		print "Bits: {0}".format(datastr[72:76])
		print "Remainder: {0}".format(datastr[76:])
